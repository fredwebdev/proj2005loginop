            ...
            <div class="section">
                <div class="row">
                    ...
                    <div class='col s4 center' style='margin-top: 0.5rem'>
                        <div class='col s12'>
                            <a href="articles" class="btn btn-large btn-bleu modal-trigger col s8">Proposer un article</a>
                        </div>
                        <div class='col s12'>
                            <a href="connexion" class="btn btn-large btn-bleu modal-trigger col s8">Connectez-vous</a>
                        </div>
                    </div>
                </div>
            </div>
